...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    arguments: Schema.Attribute.Component<'home.arguments-blocks', false>;
    citation: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    firstSection: Schema.Attribute.Component<'about.premiere-section', false>;
    lastSection: Schema.Attribute.Component<
      'about.parcours-professionnel',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCreationCreation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    realisationDuration: Schema.Attribute.Decimal;
    shortDescription: Schema.Attribute.RichText;
    slug: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_main: Schema.Attribute.Component<'footer.footer-main', false>;
    links_category: Schema.Attribute.Component<'footer.footer-nav-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    social_network_links: Schema.Attribute.Component<'nav.nav-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    links: Schema.Attribute.Component<'header.nav-item-with-sublinks', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    About: Schema.Attribute.Component<'home.about-creator', false>;
    Arguments: Schema.Attribute.Component<'home.arguments-blocks', false>;
    Blogs: Schema.Attribute.Component<'home.blogs-block', false>;
    Categories: Schema.Attribute.Component<'home.category-block', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creations: Schema.Attribute.Component<'home.creations', false>;
    ...
    > &
      Schema.Attribute.Private;
    Produits: Schema.Attribute.Component<'home.products-block', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInformationInformation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isAdditionalInformation: Schema.Attribute.Boolean;
    label: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    product_informations: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Relation<
      ...
      'api::category.category'
    >;
    Couleurs: Schema.Attribute.Component<'product.color-variant', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    Informations: Schema.Attribute.Component<'product.informations', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    > &
      Schema.Attribute.Private;
    longDescription: Schema.Attribute.RichText;
    Pompom: Schema.Attribute.Component<'product.pompon-variant', false>;
    ...
    shortDescription: Schema.Attribute.RichText;
    slug: Schema.Attribute.String;
    Taille: Schema.Attribute.Component<'product.size-variant', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
